...
public class WordCount {
    ...
    public static class TokenizerMapper
        ...
        private void parseSkipFile(String fileName){
            try {
                ...
                System.out.println("Caught exception while parsing the " +
                        "cached file" + StringUtils.stringifyException(ioe));
            }
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        GenericOptionsParser optsParser = new GenericOptionsParser(conf, args);
        String[] remainingArgs = optsParser.getRemainingArgs();
        ...
        for (int i = 0; i < remainingArgs.length; i++){
            if (remainingArgs[i].equals("-skip")){
